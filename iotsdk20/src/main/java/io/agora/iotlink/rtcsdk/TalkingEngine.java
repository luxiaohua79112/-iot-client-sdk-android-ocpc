...
public class TalkingEngine implements AGEventHandler,
    ...
    private final IDevPreviewMgr.RtcNetworkStatus mRtcStatus = new IDevPreviewMgr.RtcNetworkStatus();
    ...
    public boolean initialize(InitParam initParam) {
        ...
        ALog.getInstance().i(TAG, "<initialize> done, mMaxEncodeWidth=" + mMaxEncodeWidth
    ...
    public void release()
    {
        ...
        if (mRtcEngEventHandler != null) {
            ...
            ALog.getInstance().i(TAG, "<release> done");
        }
    }
     ...
     * @brief 获取当前RTC网络状态
     */
    public IDevPreviewMgr.RtcNetworkStatus getNetworkStatus() {
        IDevPreviewMgr.RtcNetworkStatus retStatus = new IDevPreviewMgr.RtcNetworkStatus();
    ...
    public boolean leaveChannel(final SessionCtx sessionCtx)   {
        ...
        ALog.getInstance().i(TAG, "<leaveChannel> Exit");
        return true;
    }
    ...
    public boolean setRemoteVideoView(final SessionCtx sessionCtx, final View remoteView)
    {
        ...
        ALog.getInstance().i(TAG, "<setRemoteVideoView> done, remoteView=" + remoteView
    ...
    public boolean subscribeStart(final SessionCtx sessionCtx) {
        ...
        long t2 = System.currentTimeMillis();
        ALog.getInstance().i(TAG, "<subscribeStart> mutePeerAudio=" + mutePeerAudio
                + ", mutePeerVideo=" + mutePeerVideo
                + ", ret=" + ret + ", retLocalAud=" + retLocalAud
                + ", retDevAudio=" + retDevAudio + ", retDevVideo=" + retDevVideo
                + ", costTime=" + (t2-t1));
        return (ret == Constants.ERR_OK);
    }
     ...
     * @brief 停止订阅音视频
     */
    public boolean subscribeStop(final SessionCtx sessionCtx) {
        if (mRtcEngine == null) {
            ALog.getInstance().e(TAG, "<subscribeStop> bad state");
            return false;
        }
        long t1 = System.currentTimeMillis();
        int ret, retLocalAud, retDevVideo, retDevAudio;
        ...
        long t2 = System.currentTimeMillis();
        ALog.getInstance().i(TAG, "<subscribeStop> mutePeerAudio=" + mutePeerAudio
                + ", mutePeerVideo=" + mutePeerVideo
                + ", ret=" + ret + ", retLocalAud=" + retLocalAud
                + ", retDevAudio=" + retDevAudio + ", retDevVideo=" + retDevVideo
                + ", costTime=" + (t2-t1));
    ...
    public boolean mutePeerVideoStream(final SessionCtx sessionCtx) {
        ...
        ALog.getInstance().i(TAG, "<mutePeerVideoStream> sessionId=" + sessionCtx.mSessionId
    ...
    public boolean mutePeerAudioStream(final SessionCtx sessionCtx) {
        ...
        ALog.getInstance().i(TAG, "<mutePeerAudioStream> sessionId=" + sessionCtx.mSessionId
    ...
    public boolean takeSnapshot(final SessionCtx sessionCtx, final String saveFilePath)
    {
        ...
        ALog.getInstance().i(TAG, "<takeSnapshot> sessionId=" + sessionCtx.mSessionId + ", ret=" + ret
    ...
    public boolean muteLocalAudioStream(final SessionCtx sessionCtx) {
        ...
        ALog.getInstance().i(TAG, "<muteLocalAudioStream> mutePeerAudio=" + mutePeerAudio
                + ", mutePeerVideo=" + mutePeerVideo
                + ", ret=" + ret + ", retLocalAud=" + retLocalAud
                + ", retDevAudio=" + retDevAudio + ", retDevVideo=" + retDevVideo
                + ", costTime=" + (t2-t1));
    ...
    public boolean setLocalAudioVolume(final SessionCtx sessionCtx, int volume) {
        ...
        long t2 = System.currentTimeMillis();
        ALog.getInstance().i(TAG, "<setLocalAudioVolume> volume=" + volume
    ...
    public boolean setAudioEffect(int voice_changer) {
        ...
        ALog.getInstance().i(TAG, "<setAudioEffect> voice_changer=" + voice_changer + ", ret=" + ret);
        return (ret == Constants.ERR_OK);
    }
    ...
    public boolean setPlaybackVolume(int volume) {
        ...
        ALog.getInstance().i(TAG, "<setPlaybackVolume> volume=" + volume + ", ret=" + ret);
        return (ret == Constants.ERR_OK);
    }
    ...
    public int recordingStart(final SessionCtx sessionCtx, final String outputFile) {
        ...
        ALog.getInstance().i(TAG, "<recordingStart> done, ret=" + ret
 ...
 */
    ...
    public int recordingStop(final SessionCtx sessionCtx) {
        if (mRecorder != null) {
            ...
            mRecorder.release();
            mRecorder = null;
            ALog.getInstance().i(TAG, "<recordingStop> done");
        }
        synchronized (mVideoDataLock) {
            mCacheVideoFrame = false;
        }
